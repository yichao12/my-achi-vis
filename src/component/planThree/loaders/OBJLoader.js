...
var OBJLoader = (function() {
    ...
    function OBJLoader(THREE, manager) {
        this.THREE = THREE;
        this.manager =
    ...
    OBJLoader.prototype = {
        ...
        load: function(url, onLoad, onProgress, onError) {
            ...
            var loader = new this.THREE.FileLoader(scope.manager);
        ...
        parse: function(text) {
            ...
            for (var i = 0, l = state.objects.length; i < l; i++) {
                ...
                if (geometry.uvs.length > 0) {
                    buffergeometry.addAttribute(
                        'uv',
                        new this.THREE.Float32BufferAttribute(geometry.uvs, 2)
                    );
                }
                ...
                for (var mi = 0, miLen = materials.length; mi < miLen; mi++) {
                    ...
                    if (this.materials !== null) {
                        ...
                        if (
                            isLine &&
                            material &&
                            !(material instanceof this.THREE.LineBasicMaterial)
                        ) {
                            var materialLine = new this.THREE.LineBasicMaterial();
                            this.THREE.Material.prototype.copy.call(
                                materialLine,
                                material
                            );
                            ...
                            isPoints &&
                            material &&
                            !(material instanceof this.THREE.PointsMaterial)
                        ) {
                            var materialPoints = new this.THREE.PointsMaterial({
                                size: 10,
                ...
                if (createdMaterials.length > 1) {
                    ...
                    if (isLine) {
                        mesh = new this.THREE.LineSegments(
                            buffergeometry,
                            createdMaterials
                        );
                    } else if (isPoints) {
                        mesh = new this.THREE.Points(
                            buffergeometry,
                            createdMaterials
                        );
                    } else {
                        mesh = new this.THREE.Mesh(
                            buffergeometry,
                            createdMaterials
                        );
                    }
